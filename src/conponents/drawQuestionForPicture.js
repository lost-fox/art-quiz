...
const drawQuestionForPicture = () => {
  ...
  index.innerHTML = `
    ...
    <main>
       <div class="question">
          <h4>Какую из этих картин написал ?</h4>
       </div>
       <div class="answers flex">
          <div class="answer answer-picture">
  ...
  dataToGit().then(() => {
    question.innerHTML = `Какую из этих картин написал ${
  ...
  for (let i = 0; i < answerButton.length; i++) {
    ...
    setImage(arrayAnswer[i], 0, answerButton[i]);
  }
